...
<div className=''>
           <h1 className='my-10 py-10 '><div className=" w-full ">
  <table className="table w-full">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          Head of Machine Vision and Autonomous System
          <br/>
        </td>
        <td>2020-2022</td>
      </tr>
      ...
      <tr>
        ...
        <td>
          Engineer at Ai and Autonomous System
          <br/>
        </td>
        <td>2020-2021</td>
      </tr>
      ...
      <tr>
        <td>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-bold">Laboratory of Space Engineering and Technnology</div>
