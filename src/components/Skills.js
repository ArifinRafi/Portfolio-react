...
const Skills = () => {
    return (
        <div>
            <h1 className='text-3xl font-bold'>I am a tech enthusias with multiple types of skillsets</h1>

            <div className='lg:flex flex-row my-10 mx-10 pl-10'>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    <img src={webApp} className="w-full xl:h-4/5 rounded-lg" />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img src={mac} className="w-full xl:h-4/5 rounded-lg" />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide1" className="btn btn-circle">❮</a> 
      <a href="#slide3" className="btn btn-circle">❯</a>
    </div>
                ...
                <div className='basis-1/2'>
                    <div className='grid md:grid-cols-1 lg:grid-cols-2 gap-20'>
                        ...
                        <div> <div className="card lg:w-96 md:w-43 bg-base-50 shadow-xl">
                                <div className="card-body">
                                <h2 className="card-title justify-center">Leadership and Management</h2>
                                <p>I have worked with different NGO's and firms in rural areas across the Bangladesh. We have worked with Shopnochoyon and Amrai Bangladesh with their "Shopnopurone Shopnochoyon" Program across Bangladesh</p>
                                <div className="card-actions justify-center">
                                <button className="btn btn-primary">See More</button>
                                </div>
                                </div>
